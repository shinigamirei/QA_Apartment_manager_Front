...
export default class AvailabilityList extends React.Component {
    ...
    render() {
        ...
        let headers = [{ 'header': 'Apartment Name', 'width': 200 }, { 'header': 'Apartment Address', 'width': 200 }, { 'header': 'Apartment Region', 'width': 200 }, { 'header': 'Room Name', 'width': 100 }, { 'header': 'Current Occupancy', 'width': 200 }, { 'header': 'Next Occupancy', 'width': 200 }, { 'header': 'Availability', 'width': 100 }]
        let rows = []
